...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		getCryptoValue: function getCryptoValue() {
			var _this = this;
			...
			return axios.get('https://min-api.cryptocompare.com/data/price', {
				...
				return _this.inrValue("564");
			})
			//				.then(function (response) {
			//				console.log(response.data.INR);
			//				return response.data.INR ;
			//				})
		...
		setCrypto: function setCrypto(value) {
			this.cryptoValue = value;
		}
	},
	mounted: function mounted() {
		resolve();
		//		this.setCrypto(250);
		//		this.setCrypto(this.getCryptoValue());
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('p', [_vm._v("BITCOIN   ")]), _c('h1', [_vm._m(0), _vm._v(" " + _vm._s(_vm.inrValue.getINR()) + "    \n\t")]), _vm._v(" "), _c('p')])
